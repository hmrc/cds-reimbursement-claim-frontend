...
import uk.gov.hmrc.cdsreimbursementclaimfrontend.controllers.securities.SelectDutiesControllerSpec.{partialGenSingleDuty, securityIdWithTaxCodes}
import uk.gov.hmrc.cdsreimbursementclaimfrontend.models.ReasonForSecurity.*
import uk.gov.hmrc.cdsreimbursementclaimfrontend.models.{ReasonForSecurity, SessionData, SummaryInspectionAddress, TaxCode}
