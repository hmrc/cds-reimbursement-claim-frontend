...
class InvalidReasonForSecurityControllerSpec
  ...
  val controller: InvalidReasonForSecurityController = instanceOf[InvalidReasonForSecurityController]
    ...
    "Show Invalid Reason For Security page" must {
      ...
      "display the page" in {
        ...
        checkPageIsDisplayed(
          performAction(),
          messageFromMessageKey("invalid-reason-for-security.title")
        )
      }
    }
  }
