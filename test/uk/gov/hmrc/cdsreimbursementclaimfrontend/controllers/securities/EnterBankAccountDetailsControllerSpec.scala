...
import uk.gov.hmrc.cdsreimbursementclaimfrontend.models.generators.Generators.*
...
class EnterBankAccountDetailsControllerSpec
  ...
  "Enter Bank Account Details Controller" must {
    ...
    "handle submit requests" when {
      ...
      "the user enters details for the first time when rfs is not IPR, ENU or Nidac" in forAll(
        genBankAccountDetails,
      ...
      "the user enters details for the first time when rfs is IPR or ENU" in forAll(
        genBankAccountDetails,
      ...
      "the user enters details for the first time when rfs is Nidac" in forAll(
        genBankAccountDetails,
        ...
        checkIsRedirect(
          ...
          routes.UploadProofOfOriginController.show
        )
      }
