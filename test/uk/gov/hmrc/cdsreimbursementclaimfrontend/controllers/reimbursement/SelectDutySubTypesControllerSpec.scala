...
class SelectDutySubTypesControllerSpec
  ...
  lazy val controller: SelectDutySubTypesController = instanceOf[SelectDutySubTypesController]

  implicit lazy val messagesApi: MessagesApi = controller.messagesApi

  implicit lazy val messages: Messages = MessagesImpl(Lang("en"), messagesApi)

  "Select Duty Sub Types Controller" must {
