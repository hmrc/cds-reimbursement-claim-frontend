...
import uk.gov.hmrc.cdsreimbursementclaimfrontend.models.{BasisOfOverpaymentClaim, Feature, SessionData}
      ...
      expectedBasisOfClaims
        .map(basisOfClaim =>
          (
            ...
            BasisOfOverpaymentClaim.keyOf(basisOfClaim),
    ...
    "Submit Basis For Claim" must {
      ...
      "submit a valid basis for claim index" in forAll(
        ...
        checkIsRedirect(
          ...
          else if basisOfClaim === BasisOfOverpaymentClaim.IncorrectEoriAndDan then
