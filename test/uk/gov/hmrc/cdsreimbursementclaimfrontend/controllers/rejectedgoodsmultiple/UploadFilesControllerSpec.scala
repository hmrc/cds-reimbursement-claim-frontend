...
class UploadFilesControllerSpec
  ...
  val expectedUploadDocumentsLocation: String = "http://localhost:10100/bar/upload-files"
          ...
          mockGetSession(
            SessionData(
              journey
                ...
                .receiveUploadedFiles(UploadDocumentType.AirWayBill, journey.answers.nonce, Seq(exampleUploadedFile))
                .getOrFail
            )
          )
