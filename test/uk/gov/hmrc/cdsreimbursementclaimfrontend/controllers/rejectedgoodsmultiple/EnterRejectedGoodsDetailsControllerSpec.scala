...
import uk.gov.hmrc.cdsreimbursementclaimfrontend.journeys.RejectedGoodsMultipleJourneyGenerators.{exampleRejectedGoodsDetails, journeyWithMrnAndDeclaration}
