...
import uk.gov.hmrc.cdsreimbursementclaimfrontend.models.declaration.{ConsigneeDetails, ImportDeclaration}
    ...
    "Submit Importer Eori  page" must {
      ...
      "submit a valid Eori which is the Consignee Eori" in forAll {
        (
          ...
          val initialClaim                  = session.rejectedGoodsScheduledClaim.getOrElse(fail("No rejected goods claim"))
