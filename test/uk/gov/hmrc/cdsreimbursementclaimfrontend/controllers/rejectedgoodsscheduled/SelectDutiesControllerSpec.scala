...
import uk.gov.hmrc.cdsreimbursementclaimfrontend.claims.RejectedGoodsScheduledClaimGenerators.{claimWithMrnAndDeclaration, completeClaimGen, exampleEori}
...
import uk.gov.hmrc.cdsreimbursementclaimfrontend.models.{AmountPaidWithCorrect, DutyType, DutyTypes, ExciseCategory, SessionData, TaxCode}
