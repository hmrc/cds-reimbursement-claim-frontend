...
import uk.gov.hmrc.cdsreimbursementclaimfrontend.controllers.overpaymentsmultiple_v1.EnterDeclarantEoriNumberController
...
import uk.gov.hmrc.cdsreimbursementclaimfrontend.journeys.SecuritiesJourneyGenerators.anotherExampleEori
import uk.gov.hmrc.cdsreimbursementclaimfrontend.journeys.SecuritiesJourneyGenerators.exampleDisplayDeclaration
      ...
      "submit a valid Eori which is the Consignee Eori" in forAll { (mrn: MRN, eori: Eori) =>
        ...
        val journey                       =
          initialJourney
            ...
            .getOrFail
        val requiredSession               = session.copy(overpaymentsMultipleJourney = Some(journey))
