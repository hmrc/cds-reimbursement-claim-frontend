...
import uk.gov.hmrc.cdsreimbursementclaimfrontend.controllers.overpaymentsscheduled.CheckDeclarationDetailsController.checkDeclarationDetailsKey
...
class CheckDeclarationDetailsControllerSpec
  ...
  private val journey = JourneyBindable.Scheduled
