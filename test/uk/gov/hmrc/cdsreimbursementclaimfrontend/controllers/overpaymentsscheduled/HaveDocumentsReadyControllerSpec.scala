    ...
    "show page" must {
      ...
      "display the page" in {
        ...
        checkPageIsDisplayed(
          ...
          messageFromMessageKey(s"have-documents-ready.overpayments.scheduled.title"),
          implicit doc =>
            messageFromMessageKey("have-documents-ready.overpayments.scheduled.p1") should include(
