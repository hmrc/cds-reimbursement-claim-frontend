...
import uk.gov.hmrc.cdsreimbursementclaimfrontend.models.{SessionData, UploadDocumentType}
...
class ChooseFileTypeControllerSpec
  ...
  def validateChooseFileTypePage(doc: Document, claim: OverpaymentsScheduledClaim) = {
