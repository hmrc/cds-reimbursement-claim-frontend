...
class SelectBankAccountTypeController @Inject() (
  ...
  val postAction     = routes.SelectBankAccountTypeController.submit()
  val nextPageAction = OverpaymentsRoutes.BankAccountController.enterBankAccountDetails(JourneyBindable.Scheduled)
}
