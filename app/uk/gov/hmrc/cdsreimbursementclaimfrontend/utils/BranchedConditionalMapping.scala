...
object BranchedConditionalMapping {
  ...
  def IfEqual[T](
    ...
    BranchedConditionalMapping(condition, MandatoryOptionalMapping(ifTrue, Nil), MandatoryOptionalMapping(ifFalse, Nil))
  }
}

final case class BranchedConditionalMapping[T](
  condition: Condition,
