...
trait RejectedGoodsScheduledClaimConnector {
  def submitClaim(claimRequest: RejectedGoodsScheduledClaimConnector.Request, mitigate403: Boolean)(implicit
    hc: HeaderCarrier
...
object RejectedGoodsScheduledClaimConnector {
  ...
  final case class Request(claim: RejectedGoodsScheduledClaim.Output)
