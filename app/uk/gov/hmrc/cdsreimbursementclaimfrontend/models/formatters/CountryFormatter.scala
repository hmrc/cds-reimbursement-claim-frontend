...
package uk.gov.hmrc.cdsreimbursementclaimfrontend.models.formatters

import play.api.data.FormError
import play.api.data.format.Formatter
import uk.gov.hmrc.cdsreimbursementclaimfrontend.models.address.Country
import uk.gov.hmrc.cdsreimbursementclaimfrontend.models.address.Country.countryCodes

object CountryFormatter extends Formatter[Country] {
