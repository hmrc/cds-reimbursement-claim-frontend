...
enter-movement-reference-number.help-text=The Movement Reference Number (MRN) will be issued when an import is declared. <a class="govuk-link" rel="noreferrer noopener" target="_blank" href="{0}">Find out more about this number (opens in new tab)</a>. You can also add an entry (legacy) number found in your CHIEF documentation.
enter-movement-reference-number.enter-mrn.label=Enter the MRN or Entry number
...
#===================================================
enter-claimant-details-individual.title=Enter your claimant details as an individual
enter-claimant-details-individual.help-text=These are the details if we need to contact you about this claim application.
enter-claimant-details-individual.individual-full-name.label=Full name
enter-claimant-details-individual.individual-full-name.help=This must be your legal name
enter-claimant-details-individual.individual-full-name.error.required=Enter a full name
enter-claimant-details-individual.individual-email.label=Email address
enter-claimant-details-individual.individual-email.error.required=Enter a valid email address
enter-claimant-details-individual.individual-email.invalid=Enter a valid email address
enter-claimant-details-individual.individual-phone-number.error.required=Enter a valid phone number
enter-claimant-details-individual.individual-phone-number.invalid=Enter a valid phone number
enter-claimant-details-individual.individual-phone-number.label=Phone number
enter-claimant-details-individual.individual-phone-number.help=For international numbers include the country code.
enter-claimant-details-individual.individual-contact-address.label=Contact address
...
enter-claimant-details-individual.address-line1.error.required=Enter an address line 1
...
enter-claimant-details-individual.address-line4.error.required=Enter a valid town or city
enter-claimant-details-individual.address.line5.label=Postcode
enter-claimant-details-individual.address.line5.postcode.error.required=Enter a valid postcode
enter-claimant-details-individual.address.line6.label=Country
enter-claimant-details-individual.countryCode.error.required=Enter a country
enter-claimant-details-individual.add-company-details.label=Do you want to add company details?
enter-claimant-details-individual.add-company-details.no=No
enter-claimant-details-individual.add-company-details.yes=Yes
enter-claimant-details-individual.add-company-details.error.boolean=Choose if you want to add company details
enter-claimant-details-individual.add-company-details.error.required=Choose if you want to add company details
postcode.error.required=Enter a valid postcode
countryCode.enter-claimant-details-individual.error.required=Enter a country
nonUkAddress-line1.error.pattern=Enter a valid address line 1
nonUkAddress-line2.error.pattern=Enter a valid address line 2
nonUkAddress-line3.error.pattern=Enter a valid address line 3
nonUkAddress-line4.error.pattern=Enter a valid town or city
...
enter-claimant-details-importer-company.importer-email.invalid=Enter a valid email
enter-claimant-details-importer-company.importer-phone-number.error.required=Enter a valid phone number
enter-claimant-details-importer-company.importer-phone-number.invalid=Enter a valid phone number
...
enter-claimant-details-importer-company.address.line5.label=Postcode
enter-claimant-details-importer-company.address.line6.label=Country
...
select-reason-and-basis-for-claim.reason.select-label=Choose which reason for claim
select-reason-and-basis-for-claim.basis.select-label=Choose which basis for claim
...
select-duties.help-text=These are the duties that have been paid in the import declaration.<br />You can select any of the paid duties.
select-duties.error.required=Choose at least one duty to claim against
select-duties.duty.A00=A00 - Customs Duty
select-duties.duty.A20=A20 - Additional Duty
select-duties.duty.A30=A30 - Definitive Anti-Dumping Duty
select-duties.duty.A35=A35 - Provisional Anti-Dumping Duty
select-duties.duty.A40=A40 - Definitive Countervailing Duty
select-duties.duty.A45=A45 - Provisional Countervailing Duty
select-duties.duty.B00=B00 - Value Added Tax
select-duties.duty.A50=A50 - Customs Duty
select-duties.duty.A70=A70 - Additional Duty
select-duties.duty.A80=A80 - Definitive Anti-Dumping Duty
select-duties.duty.A85=A85 - Provisional Anti-Dumping Duty
select-duties.duty.A90=A90 - Definitive Countervailing Duty
select-duties.duty.A95=A95 - Provisional Countervailing Duty
select-duties.duty.B05=B05 - Value Added Tax

enter-claim.title=Enter the claim amount for duty {0}
enter-claim.help-text=This is to calculate your reimbursement as part of your claim. HMRC does not refund agents’ fees.
enter-claim.paid-amount-label=<strong>Paid Amount: {0}</strong>
enter-claim.claim-amount=Claim Amount
enter-claim.paid-amount=Paid Amount
enter-claim.claim-amount.hint=This is the Customs Duty amount you wish to claim for.
enter-claim.error.required=Enter an amount to claim
enter-claim.error.real=Enter a valid claim amount
enter-claim.paid-amount.error.real=Enter a valid paid amount
enter-claim.claim-amount.error.real=Enter a valid claim amount
enter-claim.invalid.claim=Enter a claim amount which is less then or equal to the paid amount
check-claim.title=Your reimbursement claim totals
check-claim.help-text=These are the calculations based on the information you gave us.
check-claim.update=<a href="{0}">Update the calculation</a>
check-claim.total=Total Reimbursement
...
enter-bank-details.help-text=This is where you would like reimbursements to be made in the UK.<br />To use these bank details again, <a class="govuk-link" rel="noreferrer noopener" target="_blank" href="{0}">contact the CDS team (opens in new tab)</a> via the imports and exports general enquiries.
...
enter-bank-details.error.moc-check-failed=Account number must be valid for the given sort code
enter-bank-details.error.account-does-not-exist=Account number must belong to an active bank account
...
bank-details.account-name.label=Account name
bank-details.sort-code.label=Sort code
bank-details.account-number.label=Account number
bank-details.different-details-link=<a href="{0}">Enter different bank details</a>
...
supporting-evidence.check-your-answers.add-another-file=<a href="{0}">Add another file</a>
...
supporting-evidence.upload.help-text=Upload supporting evidence you have received for the commodities you have imported. Files can be up to 10MB. We accept these file types JPG, PNG, and PDF.
...
check-your-answers.file-label=Document {0}
check-your-answers.bank-details.account-name.label=Account name
...
check-your-answers.claim-uk-duty.label=Amount of duty to reimburse claimed by you
check-your-answers.claim-eu-duty.label=Amount of VAT to reimburse claimed by you
check-your-answers.total-claim.label=Total claimed reimbursement
check-your-answers.reference-number.h2=MRN reference number or Entry number
check-your-answers.declaration-details.h2=Declaration details
check-your-answers.commodity-details.h2=Commodity Details
check-your-answers.claim-calculation.h2=Claim calculation
check-your-answers.bank-details.h2=Bank Details
check-your-answers.attached-documents.h2=Attached Documents
check-your-answers.reason-basis.h2=Reason or basis for claim
check-your-answers.claimant-details.h2=Claimant’s details
check-your-answers.claimant-details-as-importer.h2=Claimant’s company details
...
accessibility-statement.p7 = We are always looking to improve the accessibility of this service. If you find any problems that are not listed on this page or think we are not meeting accessibility requirements, <a class="govuk-link" rel="noreferrer noopener" target="_blank" href="{0}">report the accessibility problem (opens in a new tab)</a>.
