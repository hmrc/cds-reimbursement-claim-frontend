...
enter-movement-reference-number.rejected-goods.multiple.title=Nodwch y Cyfeirnod Symud (MRN) cyntaf
...
enter-movement-reference-number.rejected-goods.scheduled.title=Nodwch y Cyfeirnod Symud (MRN) cyntaf
